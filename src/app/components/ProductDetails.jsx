...
export default function ProductDetails({ product }) {
    return (
        <div className=" container-custom py-10 max-w-375 mx-auto">
            <div className="grid md:grid-cols-2 gap-10">
                ...
                <div>
                    ...
                    <div className="flex gap-4 ">
                        <button className="bg-techorange px-8 py-3 rounded-lg font-bold">
                            Buy Now
                        </button>
                        <button className="border border-techorange px-8 py-3 rounded-lg">
